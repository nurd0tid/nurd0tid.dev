...
export default function WebsiteIndex({ data }) {
  ...
  useEffect(() => {
    async function getGithubAPI() {
      const response = await fetch('https://api.github.com/users/nurd0tid')
        ...
        <header>
          <div className="container">
            <div className="flex-content">
              <div>
                <h1>Hey, I'm nurd0tid 👋</h1>
                <p className="subtitle small">
                  I'm a software engineer in Indonesia. I love building
            ...
            <p className="hero-buttons">
              ...
              {followers && (
                <a
                  href="https://github.com/nurd0tid"
                  target="_blank"
